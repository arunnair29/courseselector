    ...
    <div className="course-detail">
      ...
      <section>
        ...
        <dl className="detail-grid">
          ...
          <dt>
            ...
            <InfoIcon text={FIELD_INFO.applicantsPerPlace} />
          </dt>
          <dd>
      ...
      <section>
        ...
        <dl className="detail-grid">
          ...
          <dt>
            IB
            <InfoIcon text={FIELD_INFO.ibOffer} />
          </dt>
          ...
          <dt>
            Admissions tests
            <InfoIcon text={FIELD_INFO.admissionsTests} />
          </dt>
      ...
      <section>
        ...
        <dl className="detail-grid">
          ...
          <dt>
            International / year
            <InfoIcon text={FIELD_INFO.internationalFees} />
          </dt>
          <dd>{formatCurrency(course.fees.internationalAnnual)}</dd>
          <dt>
            Fee year
            <InfoIcon text={FIELD_INFO.feeYear} />
          </dt>
